...
async function testDirectVid13() {
    console.log('Testing direct vid-1.3 endpoint on Google Cloud Run...');
    console.log('Payload:', JSON.stringify(testData, null, 2));
    
    try {
        const startTime = Date.now();
        
        const response = await axios.post('https://video-editor-api-519298355551.us-central1.run.app/create-video-vid-1.3', testData, {
            headers: {
